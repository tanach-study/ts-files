...
def all(request):
    ...
    for c in all_classes:
        ...
        for t in teamim_map[c.id]:
            ...
            teamim.append(
                {
                    "reader_title": this_reader.title
                    if this_reader.title != ""
                    else None,
                    "reader_fname": this_reader.fname
                    if this_reader.fname != ""
                    else None,
                    "reader_mname": this_reader.mname
                    if this_reader.mname != ""
                    else None,
                    "reader_lname": this_reader.lname
                    if this_reader.lname != ""
                    else None,
        ...
        values.append(
            {
                ...
                "division_sponsor": c.division_sponsor
                if c.division_sponsor != ""
                else None,
                "division_sequence": c.division_sequence
                if c.division_sequence != ""
                else None,
                ...
                "segment_sponsor": c.segment_sponsor
                if c.segment_sponsor != ""
                else None,
                "segment_sequence": c.segment_sequence
                if c.segment_sequence != ""
                else None,
                ...
                "section_sponsor": c.section_sponsor
                if c.section_sponsor != ""
                else None,
                "section_sequence": c.section_sequence
                if c.section_sequence != ""
                else None,
                ...
                "series_sequence": c.series_sequence
                if c.series_sequence != ""
                else None,
        ...
        values.append(
            {
                ...
                "segment_sponsor": None
                if not c.seder_sponsor
                else talmud_sponsors_map[c.seder_sponsor],
                "segment_sequence": None if not c.seder_sequence else c.seder_sequence,
                "section": c.masechet,
                "section_name": "Masechet",
                "section_title": c.masechet.title(),
                "section_sponsor": None
                if not c.masechet_sponsor
                else talmud_sponsors_map[c.masechet_sponsor],
                "section_sequence": None
                if not c.masechet_sequence
                else c.masechet_sequence,
                "unit": c.daf,
                "unit_name": "Daf",
                "unit_title": c.daf,
                "unit_sponsor": None
                if not c.daf_sponsor
                else talmud_sponsors_map[c.daf_sponsor],
                "unit_sequence": c.daf,
                "part": "",
                "part_name": "",
                "part_title": "",
